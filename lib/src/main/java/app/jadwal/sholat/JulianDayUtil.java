...
import static app.jadwal.sholat.Constants.HOURS_IN_DAY_DOUBLE;
import static app.jadwal.sholat.Constants.MID_DAY_HOUR;
import static app.jadwal.sholat.MathUtil.acosDeg;
import static app.jadwal.sholat.MathUtil.cosDeg;
import static app.jadwal.sholat.MathUtil.sinDeg;
...
public class JulianDayUtil {
    ...
    /**
     * Return hour angle in degrees, return positive or negative infinity if
     * calculation
     * cannot be performed.
     * <p>
    ...
    public static double calculateTimeUponGeolocationPoint(double julianDayNumber) {
        ...
        return (-(1789 + 237 * TaiSynodic) * sinDeg(longitude)
